<template>
  <footer class="Footer">
    <div class="Footer__ctn container">
    ...
    .Footer__blocks {
      ...
      .Footer__block {
        ...
        .Footer__contactLogos {
          ...
          .Footer__contactImg {
            --dim-contact-img: 2rem;
            width: var(--dim-contact-img);
            height: var(--dim-contact-img);
            cursor: pointer;
          }
        }
